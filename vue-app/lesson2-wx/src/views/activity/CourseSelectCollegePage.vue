    ...
    export default {
        ...
        methods: {
            ...
            save() {
                ...
                switch (this.field) {
                    case 'course-college': {
                        this.setCourseTempLimitCollege(limit)
                        this.setCourseTempCollege(selectData)
                        this.setCourseTempLimitMajor(-1)
                        this.setCourseTempMajor([])
                        this.setCourseTempLimitGrade(-1)
                        this.setCourseTempGrade([])
                    }
                        break;
                    case 'course-major': {
                        this.setCourseTempLimitMajor(limit)
                        this.setCourseTempMajor(selectData)
                        this.setCourseTempLimitClass(-1)
                        this.setCourseTempClbum([])
                    }
                        break;
                    case 'course-grade': {
                        this.setCourseTempLimitGrade(limit)
                        this.setCourseTempGrade(selectData)
                        this.setCourseTempLimitClass(-1)
                        this.setCourseTempClbum([])
                    }
                        break;
                    case 'course-clbum': {
                        this.setCourseTempLimitClass(limit)
                        this.setCourseTempClbum(selectData)
                    }
                        break;
                }
                this.$router.go(-1)
