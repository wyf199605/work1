...
define("QueryModuleMb", ["require", "exports", "QueryModule", "Modal", "MbPage", "SwipeOut"], function (require, exports, queryModule_1, Modal_1, MbPage_1, SwipeOut_1) {
    "use strict";
    var d = G.d;
    return /** @class */ (function (_super) {
        __extends(QueryModuleMb, _super);
        // private cols : R_Field[];
        // private optionDom: HTMLElement;
        // private queryDom: HTMLElement;
        function QueryModuleMb(para) {
            return _super.call(this, para) || this;
        }
        QueryModuleMb.prototype.initEvent = function () {
            var self = this;
            d.on(this.modal.bodyWrapper, 'click', '[data-action]', function () {
                switch (this.dataset.action) {
                    case 'hide':
                        ...
                        break;
                    case 'search':
                        var errMsg = self.search();
                        if (typeof errMsg === 'string') {
                            Modal_1.Modal.alert(errMsg);
                            return false;
                        }
                        break;
                    case 'save':
            ...
            d.on(this.modal.bodyWrapper, 'click', '[data-action="add"]', function () {
                var name = this.dataset.name, qryBuilder = self.queriesCpt[name];
                if (qryBuilder) {
                    qryBuilder.rowAdd();
        ...
        QueryModuleMb.prototype.mobileScan = function () {
            var _this = this;
            var field = this.para.qm && this.para.qm.scannableField;
            if (!field) {
                return;
            }
            var cols = [], q = this.para.qm.queryparams1;
            Array.isArray(q) && q.forEach(function (obj) {
                cols.push({
                    name: obj.field_name,
                    title: obj.caption,
                    caption: obj.caption
            ...
            require(['MobileScan'], function (M) {
                _this.mbScan = new M.MobileScan({
                    container: document.body,
                    cols: cols,
                    scannableField: field.toUpperCase(),
                    scannableType: _this.para.qm.scannableType,
                    scannableTime: _this.para.qm.scannableTime,
                    callback: function (ajaxData) {
                        _this.hide();
                        return _this.search(ajaxData, true);
                    }
                });
            });
        };
        QueryModuleMb.prototype.queryDomGet = function () {
            this.cols = this.para.cols;
            if (this.modal) {
                return this.modal.bodyWrapper;
            }
            var body, title, qm = this.para.qm;
            ...
            this.mbPage = new MbPage_1.MbPage({
                container: this.modal.bodyWrapper,
                body: body,
                left: h("a", { className: "mui-icon mui-icon-left-nav mui-pull-left", "data-action": "hide" }),
        ...
        QueryModuleMb.prototype.queryParamTplGet = function () {
            var li = h("li", { class: "mui-table-view-cell" },
                h("div", { class: "mui-slider-left mui-disabled" },
                    h("a", { class: "mui-btn", "data-type": "andOr" })),
                h("div", { class: "mui-slider-handle inner-padding-row" },
                    h("div", { "data-type": "field" }),
                    ...
                    h("div", { "data-type": "input2" })));
            setTimeout(function () {
                var wrapper = d.query('.mui-slider-left', li), left = [wrapper];
                ...
                new SwipeOut_1.SwipeOut({
                    target: li,
                    right: [
                        h("button", { "data-action": "del", class: "mui-btn mui-btn-red" }, "\u5220\u9664"),
                    ],
                    left: left
                });
            }, 100);
        ...
        QueryModuleMb.prototype.atVarTplGet = function () {
            return h("li", { class: "mui-table-view-cell mui-row" },
                h("div", { class: "mui-col-xs-4", "data-type": "title" }),
                h("div", { class: "mui-col-xs-8", "data-type": "input" }));
        };
        QueryModuleMb.prototype.show = function () {
            if (this.modal) {
                this.modal.isShow = true;
            }
        };
        QueryModuleMb.prototype.hide = function () {
            if (this.modal) {
        ...
        //
        // }
        QueryModuleMb.prototype.rightTpl = function (qm) {
            return h("a", { className: "mui-btn mui-btn-link mui-pull-right" },
                h("button", { "data-com-type": "textCase" }),
                qm.setting ? h("button", { className: "btn button-type-link button-blue iconfont icon-baocun", "data-action": "save" }) : "",
                h("button", { className: "btn button-type-link button-blue iconfont icon-sousuo", "data-action": "search" }));
        };
        QueryModuleMb.prototype.bodyTpl = function (qm) {
            var atvarHeight = 0, atva = qm.atvarparams, q0 = qm.queryparams0, q1 = qm.queryparams1;
            atva && (atvarHeight = atva.length * 41);
            return h("div", { className: "query" },
                h("div", { style: "height:" + (atvarHeight + 1) + "px" }, atva ? h("ul", { className: "mui-table-view", "data-query-name": "atvarparams" }) : ''),
                h("div", { style: "height: calc(100% - " + atvarHeight + "px)" },
                    q0 ? h("ul", { className: "mui-table-view", "data-query-name": "queryparams0" }) : '',
                    q0 ? h("div", { "data-action": "add", "data-name": "queryparams0", className: "mui-btn mui-btn-block mui-btn-primary" },
                        h("span", { className: "mui-icon mui-icon-plusempty" }),
                        " \u6DFB\u52A0\u6761\u4EF6") : '',
                    q1 ? h("ul", { className: "mui-table-view", "data-query-name": "queryparams1" }) : '',
                    q1 ? h("div", { "data-action": "add", "data-name": "queryparams1", className: "mui-btn mui-btn-block mui-btn-primary" },
                        h("span", { className: "mui-icon mui-icon-plusempty" }),
                        " \u6DFB\u52A0\u6761\u4EF6") : ''));
        };
        return QueryModuleMb;
