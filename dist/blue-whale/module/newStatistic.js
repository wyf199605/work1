define("NewStatisticBasic", ["require", "exports", "BwRule", "SelectBox", "statistic", "Modal", "Button", "InputBox", "NewStatisticBase"], function (require, exports, BwRule_1, selectBox_1, statistic_1, Modal_1, Button_1, InputBox_1, statisticBasic_1) {
    "use strict";
    var _a;
    ...
    return (_a = /** @class */ (function (_super) {
            __extends(NewStatisticBasic, _super);
            function NewStatisticBasic(para) {
             ...
             * 获取统计表的模态框
             * */
            NewStatisticBasic.prototype.getModal = function () {
                return this.modal;
            };
            /*
             * 初始化弹框中需要统计的字段
             * */
            NewStatisticBasic.prototype.getSelectData = function () {
             ...
             * */
            NewStatisticBasic.prototype.initDataName = function (name, el) {
                var self = this;
                switch (name) {
             ...
             * 初始化统计表模态框
             * */
            NewStatisticBasic.prototype.initModal = function () {
                var self = this;
                var okFun = function () {
             ...
             * */
            NewStatisticBasic.prototype.replaceDataName = function () {
                var _this = this;
                this.body = this.modal.bodyWrapper;
                var tpl = NewStatisticBasic.getDom();
            ...
            * 获取某一列在表格数据中的序号
            * */
            NewStatisticBasic.prototype.colName2index = function (col) {
            ...
            * 统计过程
            * */
            NewStatisticBasic.prototype.colStatistic = function (cols, stats, groupCol) {
             ...
             * 初始化界面Dom
             * */
            NewStatisticBasic.getDom = function () {
            ...
            return NewStatisticBasic;
        }(statisticBasic_1.NewStatisticBase)),
        _a.mathMethodCn = {
            'sum': '合计值',
            'avg': '平均值',
            'max': '最大值',
...
define("NewCrossTabBasic", ["require", "exports", "Button", "Modal", "SelectBox", "statistic", "InputBox", "NewStatisticBase"], function (require, exports, Button_1, Modal_1, selectBox_1, statistic_1, InputBox_1, statisticBasic_1) {
    "use strict";
    var dom = G.d;
    var sys = BW.sys;
    return /** @class */ (function (_super) {
        __extends(NewCrossTabBasic, _super);
        function NewCrossTabBasic(conf) {
            var _this = _super.call(this) || this;
            _this.conf = conf;
         ...
         * 获取交叉制表的模态框
         * */
        NewCrossTabBasic.prototype.getModal = function () {
            return this.modal;
        };
        /*
         * 初始化弹框中需要统计的字段
         * */
        NewCrossTabBasic.prototype.getSelectData = function () {
         ...
         * 替换data-name属性为相应的节点并且将所有节点保存到coms数组中
         * */
        NewCrossTabBasic.prototype.initDataName = function (name, el) {
            var self = this;
            switch (name) {
                case 'row':
                ...
                case 'statistic_fixed':
                    this.coms['statistic_fixed'] = new selectBox_1.SelectBox({
                        container: el,
                        select: {
                            multi: true,
                            callback: function (index) { }
         ...
         * 初始化交叉制表模态框
         * */
        NewCrossTabBasic.prototype.initModal = function () {
            var _this = this;
            ...
            var okFun = function () {
                var row = self.coms['row'], col = self.coms['col'], val = self.coms['val'], 
                ...
                result = statistic_1.Statistic.crossTable.init({
                    row: rowTmp,
                    col: colTmp,
                    val: valTmp,
                    cols: self.conf.cols,
                    ...
                    isFixed: _this.coms['statistic_fixed'].get().length === 1,
                }).then(function (ev) {
                    self.tableRender(ev, self.conf.container, true);
                }).catch(function (msg) {
                    Modal_1.Modal.alert(msg);
                });
                // self.modal.isShow = false;
                return false;
            };
         ...
         * 替换dom中含有data-name属性的节点
         * */
        NewCrossTabBasic.prototype.replaceDataName = function () {
            var _this = this;
            this.body = this.modal.bodyWrapper;
            var tpl = NewCrossTabBasic.getDom();
            this.body.innerHTML = tpl;
            dom.queryAll('[data-name]', this.body).forEach(function (el) {
                _this.initDataName(el.dataset.name, el);
            });
        ...
        * 取消选择相同的行列或者值
        * */
        NewCrossTabBasic.prototype.cancleSame = function (type, index) {
         ...
         * 初始化界面Dom
         * */
        NewCrossTabBasic.getDom = function () {
            return '<div class="row">' +
                '<div class="col-xs-4">' +
                '<fieldset class="col-xs-12">' +
                '<legend>行</legend>' +
        ...
        return NewCrossTabBasic;
    }(statisticBasic_1.NewStatisticBase));
});

define("NewAnalysisBasic", ["require", "exports", "SelectBox", "statistic", "TextInput", "Modal", "Button", "InputBox", "NewStatisticBase"], function (require, exports, selectBox_1, statistic_1, text_1, Modal_1, Button_1, InputBox_1, statisticBasic_1) {
    "use strict";
    /// <amd-module name="NewAnalysisBasic"/>
    var dom = G.d;
    var tools = G.tools;
    return /** @class */ (function (_super) {
        __extends(NewAnalysisBasic, _super);
        function NewAnalysisBasic(conf) {
            var _this = _super.call(this) || this;
            _this.conf = conf;
        ...
        * 获取ABC分析的模态框
        * */
        NewAnalysisBasic.prototype.getModal = function () {
            return this.modal;
        };
        /*
        * 初始化弹框中需要统计的字段
        * */
        NewAnalysisBasic.prototype.getSelectData = function () {
        ...
        * 初始化ABC分析表模态框
        * */
        NewAnalysisBasic.prototype.initModal = function () {
            var _this = this;
            var self = this, inputBox = new InputBox_1.InputBox(), savaBtn = new Button_1.Button({
                content: '设为默认值',
                key: 'savaBtn',
            ...
            if (tools.isMb) {
                this.modal = new Modal_1.Modal({
                    position: 'full',
                    isOnceDestroy: true,
                    body: G.d.create("<div>" + NewAnalysisBasic.getDom() + "</div>"),
                    header: 'abc分析',
                });
                this.modal.modalHeader.rightPanel = (function () {
                    var rightInputBox = new InputBox_1.InputBox(), okBtn = new Button_1.Button({
        ...
        * 替换data-name属性为相应的节点并且将所有节点保存到coms数组中
        * */
        NewAnalysisBasic.prototype.initDataName = function (name, el) {
            var self = this;
            switch (name) {
                case 'classify':
        ...
        * 判断用户输入是否合法
        * */
        NewAnalysisBasic.prototype.checkIsOk = function (statisticResult) {
        ...
        * 替换dom中含有data-name属性的节点
        * */
        NewAnalysisBasic.prototype.replaceDataName = function () {
            var _this = this;
            this.body = this.modal.bodyWrapper;
        ...
        * 获取用户输入
        * */
        NewAnalysisBasic.prototype.getUserInput = function () {
        ...
        * 初始化界面Dom
        * */
        NewAnalysisBasic.getDom = function () {
            return '<div class="row">' +
                '<div class="col-xs-4">' +
                '<fieldset class="col-xs-12">' +
                '<legend>分类</legend>' +
        ...
        return NewAnalysisBasic;
    }(statisticBasic_1.NewStatisticBase));
});

define("NewChartBasic", ["require", "exports", "echarts", "Modal", "SelectBox", "SelectInput", "Echart", "Button", "InputBox", "BwRule", "BwTableModule"], function (require, exports, echarts, Modal_1, selectBox_1, selectInput_1, echart_1, Button_1, InputBox_1, BwRule_1, BwTableModule_1) {
    "use strict";
    var _a;
    var tools = G.tools;
    var dom = G.d;
    ...
    return (_a = /** @class */ (function () {
                    ...
                    chartArr[0] = function (para) {
                        ...
                        for (var key1 in para['ySeries']) {
                            if (!tools.isEmpty(para['ySeries'][key1])) {
                                ...
                                yAxis.push({
                                    name: NewChartBasic.yType[key1],
                                    type: NewChartBasic.yType[key1] === '时间' ? 'time' : 'value',
                                    axisLabel: {
                                        fontSize: fontSize
                                    }
                                });
                        ...
                        var isDrill = this.para.getTablePara().isReplaceTable;
                        ...
                        for (var i = 0; i < para['legend'].length; i++) {
                            color.push(NewChartBasic.getRandomCol());
                        }
                        echart.color = color;
             ...
             * 获取表格中的统计字段
             */
            NewChartBasic.prototype.getSelectData = function () {
                var visibleCol = this.para.getVisibleCol();
             ...
             * 初始化弹框
             */
            NewChartBasic.prototype.initModal = function () {
                var _this = this;
                var self = this, inputBox = new InputBox_1.InputBox(), okBtn = new Button_1.Button({
                    ...
                    onClick: function () {
                        ...
                        if (doSta) {
                            _this.modal.isShow = false;
                            var isDrill = _this.para.getTablePara().isReplaceTable;
                            //如果是钻取则初始化钻取的按钮（图形统计，返回表格）
                            if (isDrill) {
                                var wrapper_1 = _this.para.getWrapper(), wrapperParent_1 = sys.isMb ? d.closest(wrapper_1, 'li') : wrapper_1.parentNode, echartBody_1, tableBut_1, fullScreenBut = void 0;
                                wrapper_1.style.display = 'block';
                                echartBody_1 = document.createElement('div');
                                echartBody_1.className = 'Echart_body';
                                echartBody_1.style.height = sys.isMb ? '80vh' : '450px';
                                echartBody_1.style.width = sys.isMb ? '700px' : wrapper_1.offsetWidth + 'px';
                                wrapper_1.style.display = 'none';
                                var hasChart = d.query('.Echart_body', wrapperParent_1);
                                if (tools.isNotEmpty(hasChart)) {
                                    d.remove(hasChart);
                                }
                                wrapper_1.parentNode.appendChild(echartBody_1);
                                ...
                                tableBut_1 = tools.isMb ? d.query('.icon-biaoge', wrapperParent_1).parentNode
                                    : d.query('.statistics-table', wrapperParent_1.parentNode.parentNode);
                                tools.isMb ? tableBut_1.classList.remove('hide') : tableBut_1.style.display = 'inline-block';
                                var clickHandler_1 = null;
                                d.on(tableBut_1, 'click', clickHandler_1 = function (ev) {
                                    // ev.stopPropagation();
                                    wrapper_1.style.display = 'block';
                                    d.remove(echartBody_1);
                                    !tools.isMb && (tableBut_1.style.display = 'none');
                                    d.off(tableBut_1, 'click', clickHandler_1);
                                });
                                //处理电脑端放大之后的图形统计重新渲染事件
                                var firstHeight_1 = wrapperParent_1.offsetHeight;
                                fullScreenBut = d.query('.panel-tools', wrapperParent_1.parentElement.parentElement);
                                fullScreenBut && d.on(d.query('.panel-fullscreen', fullScreenBut), 'click', function (e) {
                                    e.preventDefault();
                                    setTimeout(function () {
                                ...
                                _this.para.callback && _this.para.callback();
                            }
             ...
             */
            NewChartBasic.prototype.initHtmlTpl = function (name, el) {
                var self = this;
                switch (name) {
                    case 'type':
             ...
             * 替换data-name为具体的节点
             */
            NewChartBasic.prototype.replaceDataName = function () {
                var _this = this;
                this.body = this.modal.bodyWrapper;
             ...
             * @param para
             */
            NewChartBasic.prototype.generateGraph = function (parentEle, type, para) {
                var _this = this;
             ...
             * @returns {string}
             */
            NewChartBasic.prototype.htmlTpl = function () {
             ...
             * @returns {Modal}
             */
            NewChartBasic.prototype.getModal = function () {
                return this.modal;
            };
            /**
             ...
             * @returns {{}}
             */
            NewChartBasic.prototype.getChartInput = function () {
                function unique(arr) {
                    var res = [], json = {}, i;
             ...
             * @returns {string}
             */
            NewChartBasic.prototype.getDataType = function (name) {
                for (var i = 0; i < this.para.cols.length; i++) {
            ...
            ;
            NewChartBasic.prototype.getLinkCol = function (trData, keyField) {
                var _this = this;
                var cols = this.para.cols;
                ...
                cols.forEach(function (col, index) {
                    ...
                    var url = BwTableModule_1.drillUrlGet(field, trData, keyField);
                    if (tools.isNotEmpty(url)) {
                        inLinkCol(field, url);
                    }
                    // for (let attr of ['drillAddr', 'webDrillAddr', 'webDrillAddrWithNull']) {
                    //     if(attr in field){
                    //         let addr = BwRule[attr](field[attr], trData, keyField);
                    //         inLinkCol(field, addr);
                    //     }
                    // }
...
define("NewStatisticBase", ["require", "exports", "Modal", "FastBtnTable"], function (require, exports, Modal_1, FastBtnTable_1) {
    "use strict";
    ...
    var tools = G.tools;
    var sys = BW.sys;
    var NewStatisticBase = /** @class */ (function () {
        function NewStatisticBase() {
        }
        /**
         * 生成统计结果的表格弹窗
         ...
         */
        NewStatisticBase.prototype.tableRender = function (result, container, isMulit) {
            if (isMulit === void 0) { isMulit = false; }
            var tempTable = dom.create('<div style="height: 100%;"></div>');
            ...
            new FastBtnTable_1.FastBtnTable(para);
            // loading.hide();
        ...
        return NewStatisticBase;
    }());
    exports.NewStatisticBase = NewStatisticBase;
});

/// <amd-module name="NewCount"/>
define("NewCount", ["require", "exports", "NewStatisticBase", "SelectInput", "Modal", "SelectInputMb"], function (require, exports, statisticBasic_1, selectInput_1, Modal_1, selectInput_mb_1) {
    "use strict";
    var sys = BW.sys;
    var d = G.d;
    var tools = G.tools;
    return /** @class */ (function (_super) {
        __extends(NewCount, _super);
        function NewCount(para) {
            var _this = _super.call(this) || this;
            _this.para = para;
            _this.modal = null;
            _this.initModal();
        ...
        NewCount.prototype.count = function (colName) {
        ...
        NewCount.prototype.initModal = function () {
            var _this = this;
            this.modal = new Modal_1.Modal({
                header: '统计',
                ...
                onOk: function () {
                    ...
                    var data = _this.para.colDataGet(selectInput.get());
                    for (var key in data) {
                        tablePara.data.push({
                            colName: key,
                            count: data[key]
        ...
        NewCount.prototype.getModal = function () {
            return this.modal;
        };
        return NewCount;
    }(statisticBasic_1.NewStatisticBase));
