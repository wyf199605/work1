...
define("MbTable", ["require", "exports", "BasicTable"], function (require, exports, basicTable_1) {
    ...
    var MbTable = /** @class */ (function (_super) {
        ...
        function MbTable(para) {
            ...
            _this.colReorder = (function () {
                var reorderPanel = null, allCol = null, isPanelShowed = false;
                var init = function () {
                    //  console.log(234);
                    reorderPanel = G.d.create('<div class="mobileTableReorderPanel"><div class="buttons">' +
                    ...
                    var colList = G.d.create('<ul class="colList"></ul>');
                ...
                var show = function () {
                    ...
                    var colListDom = reorderPanel.querySelector('.colList');
                    colListDom.innerHTML = '';
                    allCol = [];
                    _this.conf.cols.forEach(function (col, i) {
                        var li = G.d.create("<li data-col-index=\"" + i + "\"><span>" + col.title + "</span></li>");
                        allCol.push(li);
                ...
                var initEvent = function () {
                    var dragingDom = null, colListDom = reorderPanel.querySelector('.colList'), commonHeight = 0, insertBeforeCol = null, self = _this, colListDomPaddingTop = 10, colListDomPaddingLeft = 10, colListDomTop = colListDom.offsetTop + colListDomPaddingTop, startTop = 0, startLeft = 0; //padding top 10
                    mui(reorderPanel).on('dragstart', '.colList>li', function (e) {
                        if (commonHeight === 0) {
                            commonHeight = this.offsetHeight;
                        }
                        var touch = e.detail.touches[0], rect = this.getBoundingClientRect();
                        // debugger;
                    ...
                    mui(reorderPanel).on('drag', '.colList>li', function (e) {
                        ...
                        // console.log(e);
                        var lastColHalfWidth = 0, thisPos = e.detail.touches[0], thisWidth = parseInt(this.dataset.width), thisTop = thisPos.clientY - colListDomTop - startTop, thisLeftX = thisPos.clientX - colListDomPaddingLeft - startLeft;
                        ...
                        for (var i = 0, col = void 0; col = allCol[i]; i++) {
                ...
                function calcReorderColsPos(allCol, stopCol, noWidth) {
        ...
        MbTable.prototype.initColReorder = function () {
            //  console.log(234);
            var reorderPanel = G.d.create('<div class="mobileTableReorderPanel"><div class="buttons">' +
                '<button class="mui-btn mui-btn-link cancel" data-action="cancel">取消</button>' +
                '<button class="mui-pull-right mui-btn-link mui-btn" data-action="sure">确定</button></div></div>'), colList = G.d.create('<ul class="colList"></ul>');
            reorderPanel.appendChild(colList);
            document.body.appendChild(reorderPanel);
        ...
        MbTable.prototype.initColReorderDragEvent = function (reorderPanel) {
            var dragingDom = null, colListDom = reorderPanel.querySelector('.colList'), commonHeight = 0, insertBeforeCol = null, self = this, colListDomPaddingTop = 10, colListDomPaddingLeft = 10, colListDomTop = colListDom.offsetTop + colListDomPaddingTop, startTop = 0, startLeft = 0; //padding top 10
            mui(reorderPanel).on('dragstart', '.colList>li', function (e) {
                if (commonHeight === 0) {
                    commonHeight = this.offsetHeight;
                }
            ...
            mui(reorderPanel).on('drag', '.colList>li', function (e) {
                ...
                dragingDom.style.left = thisLeftX + "px";
                dragingDom.style.top = thisTop + "px";
                for (var i = 0, col = void 0; col = self.allCol[i]; i++) {
                    var colHalfWidth = parseInt(col.dataset.width) / 2, colTop = parseInt(col.dataset.top);
                    // 判断在不在此行
                    // console.log(`${colTop} + ${commonHeight} < ${thisTop} + ${commonHeight / 2}`);
                    if (colTop + commonHeight < thisTop + (commonHeight / 2)) {
            ...
            d.on(d.query('.buttons', reorderPanel), 'click', '.mui-btn', function (e) {
                ...
                switch (this.dataset.action) {
                    ...
                    case 'sure':
                        // debugger;
                        reorderPanel.style.display = 'none';
                        var newOrderCols = [], allCols = d.queryAll('.colList li', reorderPanel);
                        for (var i = 0, col = void 0; col = allCols[i]; i++) {
                            newOrderCols.push(self.conf.cols[parseInt(col.dataset.colIndex)]);
                        }
                        self.conf.cols = newOrderCols;
                        self.theadRender();
        ...
        ;
        MbTable.prototype.destroy = function () {
...
define("TableModuleMb", ["require", "exports", "TableModule", "MbTable", "SubPage", "CheckBox", "SelectBox", "InputBox", "Button", "Modal", "Popover"], function (require, exports, tableModule_1, mbTable_1, subPage_1, checkBox_1, selectBox_1, InputBox_1, Button_1, Modal_1, popover_1) {
    "use strict";
    var tools = G.tools;
    var d = G.d;
    return /** @class */ (function (_super) {
        __extends(TableModuleMb, _super);
        function TableModuleMb() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.frontBtnsInit = (function () {
                var target = d.query('[data-target="popover"]'), btns = [
                ...
                ], self = _this, popover, items = btns.map(function (item) {
                    return {
                        title: item.title,
                        icon: item.icon
                    };
            ...
            _this.indexColShowBtn = (function () {
                var checkBox = null;
                var init = function () {
                    if (_this.para.isSub) {
                        return;
                    }
                    var header = d.query('body > header.mui-bar.mui-bar-nav > [data-action="indexCol"]');
                    checkBox = new checkBox_1.CheckBox({
                        ...
                        onSet: function (isChecked) {
                            _this.table.indexColFun.show(isChecked);
                            if (_this.subTable && _this.subTable.table) {
                                _this.subTable.table.indexColFun.show(isChecked);
                            }
                        }
                    });
                };
            ...
            _this.handleSubTable = (function () {
                var subContent = null, subTable = null;
                return function (subUrl, ajaxData, onShow, onClose) {
                    // 初始化subPage
                    if (subContent === null) {
                        subContent = subPage_1.SubPage.create();
                        // 创建子表dom并添加到subPage的content区域中
                        subTable = h("table", { className: "mobileTable subTable" });
                        subContent.appendChild(subTable);
                    }
                    // 展示subPage
                    subPage_1.SubPage.show(function () {
                        // 初始化子表
                        if (_this.subTable === null) {
                            _this.subTable = new TableModuleMb({
                                tableEl: subTable,
                                scrollEl: subContent,
                                ajaxData: ajaxData,
                            }, _this.subTableData);
                            ...
                            subPage_1.SubPage.getLoading().classList.remove('hide');
                            _this.subTable.refresher(ajaxData, function () {
                                subPage_1.SubPage.getLoading().classList.add('hide');
                            });
                        }
                    });
                    onShow();
                    ...
                    subPage_1.SubPage.onClose(onClose);
                };
            })();
            return _this;
        }
        TableModuleMb.prototype.initWrapper = function (tableDom) {
            this.wrapper = h("div", { className: "table-module-wrapper" });
            d.append(tableDom.parentElement, this.wrapper);
            d.append(this.wrapper, tableDom);
        };
        TableModuleMb.prototype.onComplete = function () {
            /**
            ...
            if (!this.isDrill && !this.para.isSub && !this.para.isInModal) {
                this.initSearch();
                setTimeout(function () {
                    _this.indexColShowBtn.init();
                    _this.frontBtnsInit.init();
                }, 0);
            }
        };
        TableModuleMb.prototype.initSearch = function () {
            var _this = this;
            var tableWrap = this.table.wrapperGet(), searchEl = h("div", { className: "search-input mui-input-row" },
                h("label", null,
                    h("span", { className: "mui-icon mui-icon-search grey" })),
                h("input", { type: "text", placeholder: "\u8BF7\u8F93\u5165...", className: "mui-input-clear mui-input", autocapitalize: "off", autocorrect: "off" }));
            d.before(tableWrap, searchEl);
            var height = searchEl.clientHeight;
            if (this.para.isSub) {
            ...
            var input = d.query('input', searchEl);
            // 初始化
            mui(input).input();
            inputOnChange(function () { return _this.table.search(input.value); });
            function inputOnChange(callback) {
                var timer = null, nowTime = 0, lastTime = 0, timeInterval = 500; //节流，300毫秒触发一次
                ...
                setTimeout(function () {
                    d.on(input.nextElementSibling, 'tap', function (e) {
                        callback();
                        input.blur();
                        input.focus();
                    });
        ...
        // 扫码
        TableModuleMb.prototype.mobileScan = function () {
            var _this = this;
            var field = this.para.scannableField;
            if (!field) {
                return;
            }
            ...
            require(['MobileScan'], function (M) {
                new M.MobileScan({
                    ...
                    cols: _this.para.cols,
                    scannableField: field.toUpperCase(),
                    scannableType: _this.para.scannableType,
                    scannableTime: _this.para.scannableTime,
                    callback: function (ajaxData) {
                        if (_this.queryModule) {
                            _this.queryModule.hide();
                            return _this.queryModule.search(ajaxData, true);
                        }
                        else {
                            return _this.refresher(ajaxData);
                        }
                    }
                });
            });
        };
        TableModuleMb.prototype.footerBtnsInit = function () {
            // 初始化按钮
            var hasSub = !tools.isEmpty(this.para.subButtons), hasEdit = this.editBtns.has();
            if (hasSub || hasEdit) {
                this.subBtnWrapper = h("footer", { className: "mui-bar mui-bar-footer" });
                var btnWrapper_1 = null;
                if (hasSub && hasEdit) {
                    btnWrapper_1 = h("div", { className: "all-btn" });
                    var sub_1 = null, edit_1 = null;
                    new checkBox_1.CheckBox({
                        className: 'edit-toggle',
                        container: this.subBtnWrapper,
                        onClick: function (isChecked) {
                            sub_1.classList[isChecked ? 'add' : 'remove']('hide');
                            edit_1.classList[!isChecked ? 'add' : 'remove']('hide');
                        }
                    });
                    d.append(this.subBtnWrapper, btnWrapper_1);
                    setTimeout(function () {
                        var _a;
                        _a = d.queryAll('.input-box', btnWrapper_1), sub_1 = _a[0], edit_1 = _a[1];
                        edit_1.classList.add('hide');
                    }, 50);
                }
                else {
                    btnWrapper_1 = this.subBtnWrapper;
                }
                if (hasSub) {
                    this.initSubBtns(btnWrapper_1);
                }
                if (hasEdit) {
                    this.editBtns.init(btnWrapper_1);
                }
        ...
        // 导出报表
        TableModuleMb.prototype.doExport = function () {
            var _this = this;
            var body = h("div", { "data-name": "export" });
            var data = [{ value: 'csv', text: '导出csv' },
            ...
            var okBtn = new Button_1.Button({
                ...
                type: 'primary',
                onClick: function () {
                    _this.export(data[sel.get()[0]].value);
                }
            });
        ...
        TableModuleMb.prototype.tableConfGet = function (para) {
            var _this = this;
        ...
        TableModuleMb.prototype.initTable = function (para) {
            return new mbTable_1.MbTable(para);
        };
        TableModuleMb.prototype.imgHtmlGet = function (url) {
            return "<img src=\"" + url + "\" alt=\"\"/>";
        };
        TableModuleMb.prototype.destroy = function () {
            this.table.destroy();
