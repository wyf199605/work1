...
define("ButtonAction", ["require", "exports", "InputBox", "Button", "Modal", "SelectBox", "ShellErpManagePc", "SelectInput", "Loading", "BwRule", "SelectInputMb"], function (require, exports, InputBox_1, Button_1, Modal_1, selectBox_1, ShellErpManage_1, selectInput_1, loading_1, BwRule_1, selectInput_mb_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ButtonAction = /** @class */ (function () {
        ...
        ButtonAction.prototype.checkAction = function (btn, dataObj, addr, ajaxType, ajaxData, url) {
            var self = this, varType = btn.actionAddr.varType;
            if (varType === 3 && typeof ajaxData !== 'string') {
                // 如果varType === 3 则都转为数组传到后台
                if (!Array.isArray(ajaxData)) {
                    ajaxData = [ajaxData];
            ...
            if (type === 3) {
                ...
                require(['QueryBuilder'], function (q) {
                    BwRule_1.BwRule.atvar = new q.AtVarBuilder({
                        ...
                        tpl: function () { return d.create("<div class=\"atvarDom " + disabled_1 + "\"><div style=\"display: inline-block;\" data-type=\"title\"></div>\n                    <span>\uFF1A</span><div data-type=\"input\"></div></div>"); },
                        setting: res.setting
                    });
