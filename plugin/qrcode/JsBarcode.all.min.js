...
!
    function(t) {
        ...
        function(t, e) {
            ...
            var r = function() {
                ...
                return t.prototype.encode = function(t, e, n) {
                    var r = "";
                    n = n || "";
                    for (var o = 0; o < t.length; o++)"L" == e[o] ? r += this.Lbinary[t[o]] : "G" == e[o] ? r += this.Gbinary[t[o]] : "R" == e[o] && (r += this.Rbinary[t[o]]),
                    o < t.length - 1 && (r += n);
                    return r
                },
                    t
        ...
        function(t, e, n) {
            ...
            var u = n(2),
                ...
                f = function(t) {
                    function e(n, r) {
                        return o(this, e),
                            i(this, t.call(this, n + (0, c.mod10)(n), r))
                    }
                    return a(e, t),
                        e
                } (s["default"]);
        ...
        function(t, e, n) {
            ...
            var u = n(2),
                ...
                f = function(t) {
                    function e(n, r) {
                        return o(this, e),
                            i(this, t.call(this, n + (0, c.mod11)(n), r))
                    }
                    return a(e, t),
                        e
                } (s["default"]);
                ...
                p = function() {
                    ...
                    return t.prototype.render = function() {
                        ...
                        t.prototype.prepareSVG = function() {
                            for (; this.svg.firstChild;) this.svg.removeChild(this.svg.firstChild); (0, f.calculateEncodingAttributes)(this.encodings, this.options);
                        ...
                        t.prototype.drawSvgBarcode = function(t, e, n) {
                            ...
                            for (var i = 0,
                                     a = 0,
                                     s = 0; s < o.length; s++) a = s * e.width + n.barcodePadding,
                                "1" === o[s] ? i++:i > 0 && (u(a - e.width * i, r, e.width * i, e.height, t), i = 0);
        ...
        function(t, e, n) {
            ...
            function u(t, e, n) {
                e = (0, h["default"])(e);
                for (var r = 0; r < e.length; r++) e[r].options = (0, l["default"])(n, e[r].options),
                    (0, y["default"])(e[r].options); (0, y["default"])(n);
                var o = t.renderer,
            ...
            var s = n(10),
                ...
                j = function(t, e, n) {
                    ...
                    return r._renderProperties = (0, g["default"])(t),
                        r._encodings = [],
                        r._options = C["default"],
                        r._errorHandler = new x["default"](r),
                    "undefined" != typeof e && (n = n || {},
                    n.format || (n.format = a()), r.options(n)[n.format](e, n).render()),
                        r
                };
            ...
            E.prototype.options = function(t) {
                return this._options = (0, l["default"])(this._options, t),
                    this
            },
