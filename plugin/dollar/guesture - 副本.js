var initGestrue = function (id, callbacks) {
    var initCallback = {
        ...
        "zig-zag"               : function () {},
        "arrow"                 : function () {},
        "left square bracket"   : function () {},
        "right square bracket"  : function () {},
        "v"                     : function () {},
        "delete"                : function () {},
        "left curly brace"      : function () {},
        "right curly brace"     : function () {},
        "star"                  : function () {},
        "pigtail"               : function () {}
    }

    var gestureCallback = $.extend({}, initCallback, callbacks);
    ...
    function initGestrueCanvas(id) {
       ...
       // _g.strokeStyle = "rgb(0,0,225)";
        _g.fillStyle = "rgba( 0, 0, 0, 0.7)";
        _g.strokeStyle = "rgba(0, 0, 0, 0.7)";
        _g.lineWidth = 3;
    ...
    function drawConnectedPoint(from, to) {
        ...
        _g.closePath();_g.strokeStyle = "rgba(255, 255, 255, 0)";
        _g.stroke();
    }
