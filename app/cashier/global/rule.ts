...
namespace C{
    ...
    export class Rule {
        ...
        private static parseNumber(number, displayFormat) {
        ...
        static formatText(text: string | number, formats: any, isWidth = true, isNum = false) {
            ...
            let formatStr = '',
                ...
                f: any = tools.obj.merge(formatsSetting, formats),
                dataType = f.dataType,
         ...
         * @returns {object}
         */
        static varList(varList: R_VarList[] = [], data: obj | obj[], isLowerKey = false): obj | obj[] {
