...
export interface IModalHeaderPara extends IComponent{
 ...
 * 模态框头部
 */
export class ModalHeader extends Component implements IModalHeaderPara {
    ...
    set isFullScreen(isFullScreen: boolean) {
        ...
        if (!modalEnlarge && this._isFullScreen) {
            let modalEnlarge = d.create(`<span data-fullscreen="enlarge" class="iconfont icon-maximize modal-enlarge"></span>`);
