...
export class ChangePassword{
   ...
   constructor(para:IChangePasswordPara){
       let body=<div class="cpw-content">
   ...
   static initInput(){
       return <form action="#" class="password-form">
           <div class="form-group">
               <span>旧密码：</span><input class="old-password" type="password" placeholder="请输入旧密码"/>
           </div>
           <div class="form-group">
               <span>新密码：</span><input class="new-password" type="password" placeholder="请输入新密码"/>
           </div>
           <div class="form-group">
               <span>确认密码：</span><input class="confirm-password" type="password" placeholder="确认新密码"/>
           </div>
