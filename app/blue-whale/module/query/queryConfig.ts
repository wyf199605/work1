...
export class QueryConfig {
    ...
    private sectionField: SelectInputMb | SelectInput;
    private sectionNorm: SelectInputMb | SelectInput;
    ...
    private initSection() {
        ...
        if (tools.isPc) {
            //分段字段
            self.sectionField = new SelectInput(obj1);
            //分段标准
            self.sectionNorm = new SelectInput(obj2);
        } else {
            self.sectionField = new SelectInputMb(obj1);
            self.sectionNorm = new SelectInputMb(obj2);
        }
        //宽度
