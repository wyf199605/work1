...
export = class NewChartBasic{
            ...
            okBtn = new Button({
                ...
                onClick:()=>{
                    ...
                    if(doSta) {
                        ...
                        let isDrill = this.para.getTablePara().isReplaceTable;
                        ...
                        if (isDrill) {
                            ...
                            echartBody.style.height = sys.isMb ? '100%' : '450px';
                            ...
                            wrapper.parentNode.appendChild(echartBody);
                            ...
                            tableBut = tools.isMb ? <HTMLElement>d.query('.icon-biaoge', wrapperParent).parentNode
                                : <HTMLElement>d.query('.statistics-table', <HTMLElement>wrapperParent.parentNode.parentNode);
                            tools.isMb ? tableBut.classList.remove('hide') : tableBut.style.display = 'inline-block';
                            ...
                            fullScreenBut = d.query('.panel-tools', wrapperParent.parentElement.parentElement);
                            fullScreenBut && d.on(d.query('.panel-fullscreen', fullScreenBut), 'click', (e) => {
                                e.preventDefault();
                                setTimeout(() => {
                            ...
                            this.para.callback && this.para.callback();
                        }
    ...
    private getLinkCol(trData, keyField){
        ...
        cols.forEach((col, index)=>{
            ...
            let url = drillUrlGet(field, trData, keyField);
